...
Step3: Deploying LSTM to gcloud platform
       ...
       4: Type `docker build --platform=linux/amd64 . .` on cmd to build a docker image
       ...
       6: Now type `docker tag <your newest image id> gcr.io/lstm-421017/lstm` and hit enter 
       ...
       9: Type `docker push gcr.io/lstm-421017/lstm` on cmd 
       ...
       10: Go to container registry you will see your newly pushed docker image, click on that docker image, after clicking, you will be able to see
          ...
          to 1GiB and go to variable and secrets tab and click on add environment variable as follows(there will three environment variable):
                Name                                 value  
            a. GOOGLE_APPLICATION_CREDENTIALS     "lstm-442301-8b1ec0bdda12.json"
            b. BASE_IMAGE_PATH                    "https://storage.googleapis.com/lstm2804/"
            c. BUCKET_NAME                         "lstm2804"
